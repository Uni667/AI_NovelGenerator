...
def build_config_tabview(self):
    ...
    self.ai_config_tab = self.config_tabview.add("LLM 模型设置")
    self.embeddings_config_tab = self.config_tabview.add("Embedding 设置")
    self.config_choose = self.config_tabview.add("模型分配")
...
def build_ai_config_tab(self):
    ...
    def save_current_config():
        ...
        other_params = {
            ...
            "characters_involved": self.get_characters_involved_text(),
...
def build_embeddings_config_tab(self):
    ...
    # 1) Embedding API Key
    create_label_with_help(self, parent=self.embeddings_config_tab, label_text="Embedding API 密钥:", tooltip_key="embedding_api_key", row=0, column=0, font=("Microsoft YaHei", 12))
    ...
    create_label_with_help(self, parent=self.embeddings_config_tab, label_text="Embedding 地址:", tooltip_key="embedding_url", row=2, column=0, font=("Microsoft YaHei", 12))
    ...
    create_label_with_help(self, parent=self.embeddings_config_tab, label_text="Embedding 模型名称:", tooltip_key="embedding_model_name", row=3, column=0, font=("Microsoft YaHei", 12))
